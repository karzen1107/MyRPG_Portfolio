...
//public class ItemUI : MonoBehaviour, IPointerDownHandler, IDragHandler, IEndDragHandler, IPointerClickHandler, IPointerUpHandler
//{
...
//    {
//        if (Input.GetMouseButtonUp(0)) //왼쪽 버튼으로만 가능하도록
//            Destroy(this);
//    }

//    public void OnPointerClick(PointerEventData eventData)
//    {
//        if (Input.GetMouseButtonDown(0) || Input.GetMouseButtonUp(0)) //왼쪽 버튼으로만 가능하도록
//            Destroy(this);
//    }
